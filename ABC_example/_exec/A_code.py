...
This code reads one input file "A_code.in" which is a surrogate for all the namelists and input
input files a serious code might need.  What it actually does is to calculate X_dot for the 2D
system of ODEs:
...
print 'A_code Running '

# Get data from input file

data_dict = edit.input_file_to_variable_dict('A_code.in')
...
edit.variable_dict_to_output_file(variable_dict, 'A_code.out')
