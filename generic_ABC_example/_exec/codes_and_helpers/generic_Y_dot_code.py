...
"""
generic_Y_dot_code.py 3/10/2018 (Batchelor)
...
What it does is to calculate Y_dot for the 2D system of ODEs:
X_dot = a_lin*X + b_nonlin*X*Y
Y_dot = c_lin*Y + d_nonlin*X*Y
Writes Y_dot into file "Y_code.out"

This code reads two input files "Y_dot_code.in" and "integrator.out"
Y_dot_code.in contains parameters of the ODE c_lin and d_nonlin, a surrogate for
...
data needed to calculate Y_dot.
...
print('generic_Y_dot_code Running ')
